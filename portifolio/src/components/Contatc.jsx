          ...
          <div key={index}>
            ...
            <div className="card-identity">
              ...
              <p>
                ...
                Perfil<br/>Motivado pela busca constante de aprendizado e prática em projetos, possuo perfil proativo, comunicativo e adaptável, sempre em evolução para aprimorar minhas habilidades técnicas e interpessoais.<br/>
                Portfólio<br/>Atualmente, desenvolvo e compartilho minhas habilidades no meu portfólio online.<br/>
                Objetivo<br/>Busco oportunidades para crescer profissionalmente na área de tecnologia, contribuindo com soluções criativas e eficientes.
              </p>
            </div>
